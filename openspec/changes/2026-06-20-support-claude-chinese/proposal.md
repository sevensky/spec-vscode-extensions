...
当前 `openspec-for-copilot-main` 扩展主要面向 OpenAI 生态，并且大部分交互和提示仍以英文为主。随着 Claude 在国内外场景中的广泛使用，以及中文用户对本地化支持的期待，我们需要让这个扩展同时支持 Claude，并提供中文适配，从而提升中文用户的使用体验和扩展的兼容性。
...
- 影响 `vscode-extensions/openspec-for-copilot-main` 扩展代码和配置逻辑。
