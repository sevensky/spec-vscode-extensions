...
- [x] 1.1 Add `openspec-for-agent.spec.copyName` command definition with title "Copy Name" and clipboard icon
...
- [x] 2.1 Register `openspec-for-agent.spec.copyName` command in `register-spec-commands.ts`
