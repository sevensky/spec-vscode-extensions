...
- [x] 1. Register "Update Specs from Detailed Design" command in `package.json` (title: "Update Specs from Detailed Design", command: `openspec-for-agent.spec.updateSpecsFromDetailedDesign`).
